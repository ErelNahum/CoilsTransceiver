...
%% Set channels
channel = ps2000aEnuminfo.enPS2000AChannel.PS2000A_CHANNEL_A;
enabled = PicoConstants.TRUE;
type = ps2000aEnuminfo.enPS2000ACoupling.PS2000A_AC;
range = ps2000aEnuminfo.enPS2000ARange.PS2000A_2V;
offset = 0;

[status.setChA] = invoke(ps2000aDeviceObj, 'ps2000aSetChannel', channel, enabled, type, range, offset);

channel = ps2000aEnuminfo.enPS2000AChannel.PS2000A_CHANNEL_B;
enabled = PicoConstants.FALSE;
type = ps2000aEnuminfo.enPS2000ACoupling.PS2000A_AC;
range = ps2000aEnuminfo.enPS2000ARange.PS2000A_2V;
offset = 0;

[status.setChB] = invoke(ps2000aDeviceObj, 'ps2000aSetChannel', channel, enabled, type, range, offset);
...
ylim(axisHandleChA, [-2000 2000]); % Adjust vertical axis for signal.
